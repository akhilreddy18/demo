    ...
    <div>
      ...
      <GridContainer>
          ...
          <Card style={cardStyle}>
            <CardContent>
              <TextTypography>
                ...
                <Typography align="center" variant="body2" component="p" style={bodyStyle}>
                <br />
            ...
            <CardActions>
              <Box style={{paddingLeft: "50px", alignSelf: "center", alignContent: "center"}}>
        ...
        <GridItem xs={6} sm={6} md={4}>
          <Card
            style={{ backgroundColor: "#eee", height: "13vw" }}
          >
            <CardContent>
            ...
            <CardActions>
            <Box style={{marginLeft: "55px", alignContent:"center"}}>
              <Button size="small" style={buttonStyle}>
